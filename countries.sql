...
-- Üretim Zamanı: 20 Ara 2020, 14:38:23
-- Sunucu sürümü: 5.7.24-log
-- PHP Sürümü: 7.2.10
...
INSERT INTO `countries` (`id`, `rewrite`, `country`, `area_code`) VALUES
(1, 'AF', 'Afghanistan', '93'),
(2, 'AL', 'Albania', '355'),
(3, 'DZ', 'Algeria', '213'),
...
ALTER TABLE `countries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rewrite_baslik_alankod` (`rewrite`,`country`);
